...
import dev.theimpulson.fetch2core.server.FileResponse.CREATOR.FIELD_CONNECTION
import dev.theimpulson.fetch2core.server.FileResponse.CREATOR.FIELD_CONTENT_LENGTH
import dev.theimpulson.fetch2core.server.FileResponse.CREATOR.FIELD_DATE
import dev.theimpulson.fetch2core.server.FileResponse.CREATOR.FIELD_MD5
import dev.theimpulson.fetch2core.server.FileResponse.CREATOR.FIELD_SESSION_ID
import dev.theimpulson.fetch2core.server.FileResponse.CREATOR.FIELD_STATUS
import dev.theimpulson.fetch2core.server.FileResponse.CREATOR.FIELD_TYPE
